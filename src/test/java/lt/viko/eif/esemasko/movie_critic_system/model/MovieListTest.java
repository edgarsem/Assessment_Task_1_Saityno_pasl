...
public class MovieListTest {
    ...
    public void testSetAndGet() {
        ...
        movieList.setMovieList(List.of(movie));

        Assert.assertEquals(List.of(movie), movieList.getMovieList());
    }
    ...
    public void testToString() {
        ...
        var movie = new Movie(1, "Amélie", 122, List.of(actor), List.of(genre), List.of(director), List.of(writer));
        movie.setReviews(List.of(review));
        var movieList = new MovieList(List.of(movie));

        Assert.assertEquals("Movie list: [" + "\nMovie:\n\t" + "Title = Amélie\n\t" + "Length = 122 minutes\n" + "\tGenres: \n\t[\tComedy ]\n" + "\tDirectors: \n\t[\tJean-Pierre Jeunet]\n" + "\tWriters: \n\t[\tGuillaume Laurant]\n" + "\tCast: \n\t[\tAudrey Tautou. Age: 53]\n" + "\tReviews: \n\t[\t\tReview:\n\t\t\tRating = 10\n\t\t\tReview = This Movie can CHANGE your life :-)\n\t" + "\t\tUser = \tJohn Doe\n]\n" + "]\n\t", movieList.toString());
    }
}